...
<jsp:include page="header.jsp">
    ...
    <div class="goods_detail">
        <form action="../goods_add" method="post" enctype="multipart/form-data" id="addsp">
        ...
        <div class="informationall">
            ...
            <div class="textall">
                <div class="glist_content">
                    <input id="shangpingming" type="text" placeholder="请输入商品名称" name="thing_name" maxlength="10" required><br>
                    <select name="new_old">
                    ...
                    <div class="condition">
                        <a>Price</a><br>
                        <input type="number" id="price" placeholder="金额" name="price" required>
                    </div>
                    <div class="infor">
                        <textarea placeholder="请输入描述内容" name="memo" required></textarea>
                    </div>
                    <br>
                    <div class="icon">
                        <img src="..${user.photo}">
