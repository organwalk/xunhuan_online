                        ...
                        <c:forEach items="${wishList}" var="w" >
                                    <div class="orderlist wlist">
                                        ...
                                        <div class="goodsbutton">
                                            ...
                                            <div class="add">
                                                <input class="complete" type="submit" value="查看状态" onclick="window.location='../html/goods_orderdetail.html'" >
                                            </div>
                                        </div>
                                    </div>
                        </c:forEach>
                    ...
                    <div id="worderlist2" style="display:none;">
                        <c:forEach items="${donewishList}" var="dw" >
                                    <div class="orderlist wlist">
                                        ...
                                        <div class="goodsbutton">
                                            <div class="add">
                                                <input class="complete" type="submit" value="订单详情" onclick="window.location='../html/goods_orderdetail.html'">
                                            </div>
                                        </div>
                                    </div>
                        </c:forEach>
                        ...
                        <c:forEach items="${responList}" var="r" >
                                    <div class="orderlist polist">
                                        ...
                                        <div class="goodsbutton">
                                            ...
                                            <div class="add">
                                                <input class="complete" type="submit" value="等待对方确认" onclick="window.location='../html/goods_orderdetail.html'">
                                            </div>
                                        </div>
                                    </div>
                        </c:forEach>
